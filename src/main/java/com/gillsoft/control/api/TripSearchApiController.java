...
public class TripSearchApiController {
	...
	@GetMapping("/{searchId}")
	public TripSearchResponse getSearchResult(
	...
	public List<Seat> getSeats(
			@ApiParam(value = "The id of selected trip segment", required = true) @Validated @PathVariable String tripId) {
	...
	public List<Tariff> getTariffs(
			@ApiParam(value = "The id of selected trip segment", required = true) @Validated @PathVariable String tripId,
			@ApiParam(value = "The id of selected trip segment", required = true) @PathVariable(required = false) Lang lang) {
	...
	public List<Seat> updateSeats(
			@ApiParam(value = "The id of selected trip segment", required = true) @Validated @PathVariable String tripId,
			@ApiParam(value = "The list of selected seats", required = true) @Validated @RequestBody List<Seat> seats) {
